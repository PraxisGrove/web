        ...
        <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            ...
            <div className="space-y-1">
              <div className="text-xs text-gray-500">POST /api/auth/login</div>
              <div className="text-xs text-gray-500">
                POST /api/auth/register
              </div>
              <div className="text-xs text-gray-500">GET /api/auth/profile</div>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            ...
            <div className="space-y-1">
              ...
              <div className="text-xs text-gray-500">GET /api/swagger.json</div>
            </div>
          </div>
        </div>
