            ...
            <div className="flex items-end justify-between border-t border-white/10 pt-4 mt-2">
              ...
              <div className="h-24 w-24 bg-white rounded relative">
                <Image
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuA-ZWvAyBrHZc0E7-3xBG89D30v81V13va7VWYVLB0k4t6d7iMicOX2dBlOVczLV_j1sEIgPKS-XTCNG6AjYYHTB8xb5rdXp9D5rUMSyQu2P6efFj26DpxFLq7K_VnSZsjbc8C5-mNUlQEBBgWPU5rVkx6MprQ1G0enhqEsFxR79u9cTrUR9C8uTSI3yq2Ny_LVdx4vRenDNP25IV5eHyp4OvK7VeE6xBEKHtHE7Onv-g6eDJ7MqPRLVKQrAP0IDxtgZ1LDnNPwHqCb"
                  fill
                  sizes="96px"
                />
              </div>
